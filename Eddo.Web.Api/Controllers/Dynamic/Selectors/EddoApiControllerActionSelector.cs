...
namespace Eddo.Web.Api.Controllers.Dynamic.Selectors
{
    public  class EddoApiControllerActionSelector: ApiControllerActionSelector
    {
        public override HttpActionDescriptor SelectAction(HttpControllerContext controllerContext)
        {
            ...
            {
                throw new EddoException("__EddoDynamicApiControllerInfo in ControllerDescriptor.Properties 不存在 a " + typeof(DynamicApiControllerInfo).FullName + " class.");
            }
        ...
        private static HttpActionDescriptor GetActionByActionName(HttpControllerContext controllerContext, DynamicApiControllerInfo controllerInfo, string actionName)
        {
            ...
            {
                throw new EddoException("There is no action " + actionName + " defined for api controller " + controllerInfo.ServiceName);
            }
