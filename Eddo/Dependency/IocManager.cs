...
namespace Eddo.Dependency
{
    ...
    {   
        ...
        List<IConventionalDependencyRegistrar> _conventionalRegistrars = new List<IConventionalDependencyRegistrar>();
        static IocManager()
        {
        ...
        public IocManager()
        {
            ...
            IocContainer.Register(
                Component.For<IocManager, IIocManager, IIocRegistrar, IIocResolve>().UsingFactoryMethod(() => this)
                );
        }
        /// <summary>
