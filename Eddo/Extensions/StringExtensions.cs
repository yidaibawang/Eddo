...
namespace Eddo.Extensions
{
    ...
    {
        /// <summary>
        /// 如果char不以char结尾，则将字符添加到给定字符串的末尾。
        /// </summary>
        ...
        /// <summary>
        /// 判断此字符串是否为null或一个System.String.Empty字符串。
        /// </summary>
        ...
        /// <summary>
        /// 使用string.Split方法按给定的分隔符分割给定的字符串。
        /// </summary>
        ...
        /// <summary>
        /// 使用string.Split方法来分割给定的字符串 <see cref="Environment.NewLine"/>.
        /// </summary>
        ...
        /// <summary>
        ///将给定的PascalCase / camelCase字符串转换为句子（通过空格分隔单词）。
...
#if !NET46
        /// <summary>
        /// 将camelCase字符串转换为指定文化中的PascalCase字符串。
        /// </summary>
        /// <param name="str">String to convert</param>
        /// <param name="culture">An object that supplies culture-specific casing rules</param>
        /// <returns>PascalCase of the string</returns>
