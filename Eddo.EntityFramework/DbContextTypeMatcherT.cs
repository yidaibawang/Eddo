...
namespace Eddo.EntityFramework
{
    public abstract class DbContextTypeMatcher<TBaseDbContext> : IDbContextTypeMatcher, ISingletonDependency
    {
        ...
        protected DbContextTypeMatcher(IUnitOfWorkProvider currentUnitOfWorkProvider)
        {
        ...
        public virtual Type GetConcreteType(Type sourceDbContextType)
        {
            ...
            {
                throw new EddoException("Could not find a concrete implementation of given DbContext type: " + sourceDbContextType.AssemblyQualifiedName);
            }
        ...
        private void CheckCurrentUow()
        {
            ...
            {
                throw new EddoException("GetConcreteType method should be called in a UOW.");
            }
        }
        ...
        private static Type GetDefaultDbContextType(List<Type> dbContextTypes, Type sourceDbContextType, MultiTenancySides tenancySide)
        {
            ...
            throw new EddoException(string.Format(
